...
import { ClipboardList, LogOut, PanelLeft, PlusCircle, LayoutGrid, Loader2, Star, Database, RefreshCw, FileSpreadsheet } from "lucide-react";
...
const menuItems = [
  ...
  { icon: FileSpreadsheet, label: "批量新增", path: "/batch-create" },
  { icon: PlusCircle, label: "单条新增", path: "/create" },
